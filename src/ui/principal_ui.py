...
# Form implementation generated from reading ui file 'c:\Users\Yolal\ing_soft\Practica-Ing.software\src\ui\principal.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.backround.setGeometry(QtCore.QRect(0, 0, 701, 501))
...
"")
        ...
        self.fondoAzul.setGeometry(QtCore.QRect(40, 90, 621, 381))
...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\Yolal\\ing_soft\\Practica-Ing.software\\src\\ui\\imagenes/usuario (4).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.titulo1.setGeometry(QtCore.QRect(170, 100, 331, 31))
...
"font: 75 20pt \"Arial\";")
        ...
        self.titulo2.setGeometry(QtCore.QRect(190, 150, 291, 16))
        self.titulo2.setStyleSheet("color: rgb(255, 255, 255);\n"
"font: 75 11pt \"Arial\";\n"
"background-color: transparent;")
        self.titulo2.setObjectName("titulo2")
        self.funcionalidades = QtWidgets.QLabel(self.backround)
        self.funcionalidades.setGeometry(QtCore.QRect(100, 190, 511, 241))

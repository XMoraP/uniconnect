...
################################################################################
## Form generated from reading UI file 'designerrrrCfaqlF.ui'
##
...
"")
        ...
        icon = QIcon()
        icon.addFile(u"../../Downloads/Captura de pantalla 2023-09-29 133730.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"../../Downloads/Captura de pantalla 2023-09-29 134053.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon2 = QIcon()
        icon2.addFile(u"../../Downloads/menu.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"../../Downloads/Captura de pantalla 2023-09-29 134232.png", QSize(), QIcon.Normal, QIcon.Off)
